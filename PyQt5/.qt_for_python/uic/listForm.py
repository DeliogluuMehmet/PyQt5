...
# Form implementation generated from reading ui file 'c:\Users\Mehmet_DELIOGLU\Desktop\Python dersleri\Deneme\btk_tensorflow\btk_m\PyQt5\listForm.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(551, 370)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.listItems = QtWidgets.QListView(self.centralwidget)
        self.listItems.setGeometry(QtCore.QRect(20, 30, 261, 271))
        self.listItems.setObjectName("listItems")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(320, 30, 121, 271))
